...
public class AnswerController {
	...
	public String createAnswer(@Valid AnswerForm answerForm, BindingResult result, Model model,
			@PathVariable("id") Integer id, Principal principal
	/* @RequestParam String content */ ) {

		Question question = this.qService.getQuestion(id);
		// 유저 객체를 검색하기 위해서 시큐리티의 principal의 유저이름 입력
...
//	 model.addAttribute("aList",this.aService.findAllByQuestion(question));
		return String.format("redirect:/question/detail/%d", id);// 질문 상세 페이지로 다시 돌아감
	}
